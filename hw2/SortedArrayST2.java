...
public class SortedArrayST2<Key extends Comparable<Key>, Value> {
	...
	public SortedArrayST2(int size) {
	 ...
	 */
	public SortedArrayST2(Key[] keys, Value[] vals) {
	...
	private void shiftRight(int r) {
		...
		{
			Key[] tempKeys = (Key[]) new Comparable[N + 1];      // creates empty keys array
			Value[] tempVals = (Value[]) new Object[N + 1];    // creates empty values array
	...
	public boolean equals(Object x) {
		@SuppressWarnings("unchecked")
		SortedArrayST2<Key,Value> that = (SortedArrayST2<Key,Value>) x;
	 ...
	 *    
	 */
	public static SortedArrayST2<String,String> from (String keyData, String valData) {
		...
		return new SortedArrayST2(keys,vals);
	}
	...
	public static void main(String[] args) {
		...
		testPut("AEIOU","13456", "B","2", "ABEIOU","123456");
		testPut("AEIOU","13456", "Z","8", "AEIOUZ","134568");

		System.out.println("\n **Floor Tests** \n");
		testFloor("C", "B", "BEIOU", "12345");
		testFloor("B", "B", "BEIOU", "12345");
		testFloor("C", "B", "BEIOU", "12345");
		testFloor("F", "E", "BEIOU", "12345");
		testFloor("Z", "U", "BEIOU", "12345");
		testFloor("A", null, "BEIOU", "12345");

		System.out.println("\n **Range Count Tests** \n");
		rangeCountTest("1", "8", 5, "13568", "12345");
		rangeCountTest("8", "1", 5, "13568", "12345");
		rangeCountTest("1", "1", 1, "13568", "12345");
		rangeCountTest("2", "7", 3, "13568", "12345");
		rangeCountTest("7", "2", 3, "13568", "12345");
		rangeCountTest("0", "9", 5, "13568", "12345");


		System.out.println("\n **Equal Tests** \n");
		equalsTest("AEIOU","13456","AEIOU","13456", true);
		equalsTest("AEIOUZ","134567","AEIOU","13456", false);
		equalsTest("AEIOZ","13456","AEIOU","13456", false);
		equalsTest("AEIOZ","13456","AEIOZ","13457", false);
	...
	public static void testRank(String theKey, int expected, String keyData, String valData) {
		SortedArrayST2<String, String> x = from(keyData,valData);
	...
	public static void testPut(String keyInData, String valInData, 
		...
		SortedArrayST2<String, String> actual = from(keyInData,valInData);
		SortedArrayST2<String, String> expected = from(keyOutData, valOutData);
