...
public class testLinerProbingHT {


	public static void main(String[] args) {
		int minlen = 8; String file = "data/leipzig1M.txt";

		System.out.println("\nTest LinearProbing HashST Report\n");
	...
	private static void buildInititalHashtable(int minlen, String file) {
		...
		for (int N=1024; N < 300000; N*=2) {
			...
			for (int r = 1; r <= reps; r++) {
				LinearProbingHashST<MyHTClass, Integer> firstTest = new LinearProbingHashST<>();
